...
set C_modelArgList { 
	{ WBSlave_regs int 32 regular {array 16 { 1 2 } 1 1 }  }
	...
	{ WBSlave_log_in_V int 21 regular {pointer 1}  }
	{ WBSlave_log_out_V int 21 regular {pointer 0}  }
...
set portList { 
	...
	{ WBSlave_regs_address1 sc_out sc_lv 4 signal 0 } 
	{ WBSlave_regs_ce1 sc_out sc_logic 1 signal 0 } 
	{ WBSlave_regs_we1 sc_out sc_logic 1 signal 0 } 
	{ WBSlave_regs_d1 sc_out sc_lv 32 signal 0 } 
	{ WBSlave_regs_q1 sc_in sc_lv 32 signal 0 } 
	...
	{ WBSlave_log_in_V sc_out sc_lv 21 signal 4 } 
	{ WBSlave_log_in_V_ap_vld sc_out sc_logic 1 outvld 4 } 
	{ WBSlave_log_out_V sc_in sc_lv 21 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "WBSlave_log_in_V", "direction": "out", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "WBSlave_log_in_V", "role": "default" }} , 
 	{ "name": "WBSlave_log_in_V_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "WBSlave_log_in_V", "role": "ap_vld" }} , 
 	{ "name": "WBSlave_log_out_V", "direction": "in", "datatype": "sc_lv", "bitwidth":21, "type": "signal", "bundle":{"name": "WBSlave_log_out_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	WBSlave_regs { ap_memory {  { WBSlave_regs_address0 mem_address 1 4 }  { WBSlave_regs_ce0 mem_ce 1 1 }  { WBSlave_regs_q0 mem_dout 0 32 }  { WBSlave_regs_address1 mem_address 1 4 }  { WBSlave_regs_ce1 mem_ce 1 1 }  { WBSlave_regs_we1 mem_we 1 1 }  { WBSlave_regs_d1 mem_din 1 32 }  { WBSlave_regs_q1 mem_dout 0 32 } } }
	...
	WBSlave_log_in_V { ap_vld {  { WBSlave_log_in_V out_data 1 21 }  { WBSlave_log_in_V_ap_vld out_vld 1 1 } } }
	WBSlave_log_out_V { ap_none {  { WBSlave_log_out_V in_data 0 21 } } }
