...
struct WBSlave : public sc_module {
    ...
    sc_signal< sc_lv<32> > WBSlave_log_in;
    sc_signal< sc_lv<32> > WBSlave_log_out;
    ...
    sc_signal< sc_lv<32> > grp_WBSlave_getLog_fu_216_WBSlave_log_in;
    sc_signal< sc_lv<32> > grp_WBSlave_getLog_fu_216_WBSlave_log_out;
    sc_signal< sc_logic > grp_WBSlave_getLog_fu_216_WBSlave_log_out_ap_vld;
    ...
    sc_signal< sc_logic > grp_WBSlave_processSlave_fu_280_WBSlave_regs_we0;
    sc_signal< sc_lv<32> > grp_WBSlave_processSlave_fu_280_WBSlave_regs_d0;
    ...
    sc_signal< sc_lv<32> > grp_WBSlave_processSlave_fu_280_WBSlave_log_in;
    sc_signal< sc_logic > grp_WBSlave_processSlave_fu_280_WBSlave_log_in_ap_vld;
    sc_signal< sc_lv<32> > grp_WBSlave_processSlave_fu_280_WBSlave_log_out;
    ...
    void thread_grp_WBSlave_getLog_fu_216_WBSlave_log_in();
    ...
    void thread_grp_WBSlave_processSlave_fu_280_WBSlave_log_out();
