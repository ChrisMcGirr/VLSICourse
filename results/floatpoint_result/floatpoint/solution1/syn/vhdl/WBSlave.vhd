...
architecture behav of WBSlave is 
    ...
    "WBSlave,hls_ip_2014_4,{HLS_INPUT_TYPE=sc,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc6slx150tfgg484-3,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.530000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=4573,HLS_SYN_LUT=7983}";
    ...
    signal WBSlave_log_in : STD_LOGIC_VECTOR (31 downto 0);
    signal WBSlave_log_out : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_WBSlave_getLog_fu_216_WBSlave_log_in : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_WBSlave_getLog_fu_216_WBSlave_log_out : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_WBSlave_getLog_fu_216_WBSlave_log_out_ap_vld : STD_LOGIC;
    ...
    signal grp_WBSlave_processSlave_fu_280_WBSlave_regs_we0 : STD_LOGIC;
    signal grp_WBSlave_processSlave_fu_280_WBSlave_regs_d0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal grp_WBSlave_processSlave_fu_280_WBSlave_log_in : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_WBSlave_processSlave_fu_280_WBSlave_log_in_ap_vld : STD_LOGIC;
    signal grp_WBSlave_processSlave_fu_280_WBSlave_log_out : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    WBSlave_log_in_assign_proc : process(clk)
    begin
        if (clk'event and clk =  '1') then
            if ((ap_const_logic_1 = grp_WBSlave_processSlave_fu_280_WBSlave_log_in_ap_vld)) then 
                WBSlave_log_in <= grp_WBSlave_processSlave_fu_280_WBSlave_log_in;
            end if; 
        end if;
    end process;
    ...
    WBSlave_log_out_assign_proc : process(clk)
    begin
        if (clk'event and clk =  '1') then
            if ((ap_const_logic_1 = grp_WBSlave_getLog_fu_216_WBSlave_log_out_ap_vld)) then 
                WBSlave_log_out <= grp_WBSlave_getLog_fu_216_WBSlave_log_out;
            end if; 
        end if;
    end process;
    ...
    WBSlave_regs_d0_assign_proc : process(grp_WBSlave_processSlave_fu_280_WBSlave_regs_ce0, grp_WBSlave_processSlave_fu_280_WBSlave_regs_d0, grp_WBSlave_processBus_fu_336_WBSlave_regs_ce0, grp_WBSlave_processBus_fu_336_WBSlave_regs_d0)
    begin
        if ((ap_const_logic_1 = grp_WBSlave_processBus_fu_336_WBSlave_regs_ce0)) then 
            WBSlave_regs_d0 <= grp_WBSlave_processBus_fu_336_WBSlave_regs_d0;
        elsif ((ap_const_logic_1 = grp_WBSlave_processSlave_fu_280_WBSlave_regs_ce0)) then 
    ...
    WBSlave_regs_we0_assign_proc : process(grp_WBSlave_processSlave_fu_280_WBSlave_regs_ce0, grp_WBSlave_processSlave_fu_280_WBSlave_regs_we0, grp_WBSlave_processBus_fu_336_WBSlave_regs_ce0, grp_WBSlave_processBus_fu_336_WBSlave_regs_we0)
    begin
        if ((ap_const_logic_1 = grp_WBSlave_processBus_fu_336_WBSlave_regs_ce0)) then 
            WBSlave_regs_we0 <= grp_WBSlave_processBus_fu_336_WBSlave_regs_we0;
        elsif ((ap_const_logic_1 = grp_WBSlave_processSlave_fu_280_WBSlave_regs_ce0)) then 
    ...
    grp_WBSlave_getLog_fu_216_WBSlave_log_in <= WBSlave_log_in;
    ...
    grp_WBSlave_processSlave_fu_280_WBSlave_log_out <= WBSlave_log_out;
